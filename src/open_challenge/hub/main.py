...
Open Challenge has no pillars to avoid, so the full Pi/ESP32 vision +
PID stack isn't needed — the Hub drives the whole run standalone using
its built-in IMU for straight-line heading correction and the color
sensor for lap counting on the blue/orange boundary lines.
